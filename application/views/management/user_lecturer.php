...
<script>
    $(function() {
        ...
        $('#show_data').on('click', '.item-edit', function() {
            ...
            $.ajax({
                type: 'get',
                url: '<?php echo  base_url() ?>Lecturer_management/editLecturer',
                data: {
                    id: id
                },
                async: false,
        ...
        $('#show_data').on('click', '.item-delete', function() {
            ...
            if (confirmation) {
                $.ajax({
                    type: 'get',
                    async: false,
                    url: '<?php echo base_url() ?>Lecturer_management/deleteLecturer',
                    data: {
                        id: id
                    },
                    dataType: 'json',
        ...
        //function
        function showAllLecturer() {
            $.ajax({
                url: '<?php echo base_url() ?>Lecturer_management/showAllLecturer',
                async: false,
                dataType: 'json',
                success: function(data) {
                    console.log(data);
