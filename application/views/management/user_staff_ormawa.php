    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    <label for="staticEmail" class="col-sm-4 col-form-label">Pembina : </label>
                    <div class="col-sm-8">
                        <input type="text" readonly class="form-control-plaintext" name="ormawa">
                    </div>
                </div>
                <div class="form-group row">
...
<script>
    $(function() {
        ...
        $('#show_data').on('click', '.item-edit', function() {
            ...
            $.ajax({
                type: 'get',
                url: '<?php echo  base_url() ?>Staff_ormawa/editStaffOrmawa',
                data: {
                    id: id
                },
                async: false,
                ...
                success: function(data) {
                    ...
                    $('input[name=ormawa]').val(data.name_ormawa);
        ...
        $('#show_data').on('click', '.item-delete', function() {
            ...
            if (confirmation) {
                $.ajax({
                    type: 'get',
                    async: false,
                    url: '<?php echo base_url() ?>Staff_ormawa/deleteStaffOrmawa',
                    data: {
                        id: id
                    },
                    dataType: 'json',
        ...
        //function
        function showAllStaffOrmawa() {
            $.ajax({
                url: '<?php echo base_url() ?>Staff_ormawa/showAllStaffOrmawa',
                async: false,
                dataType: 'json',
                success: function(data) {
                    console.log(data);
