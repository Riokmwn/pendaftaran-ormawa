...
<script>
    ...
    $(function() {
        ...
        $('#btnAdd').click(function() {
            ...
            $('#myForm').attr('action', '<?php echo base_url() ?>Ormawa/addDocument');
        });
        ...
        $('#show_data').on('click', '.item-delete', function() {
            ...
            if (confirmation) {
                $.ajax({
                    type: 'get',
                    async: false,
                    url: '<?php echo base_url() ?>Ormawa/deleteDocument',
                    data: {
                        id: id
                    },
                    dataType: 'json',
    ...
    function showAllDocument() {
        $.ajax({
            url: '<?php echo base_url() ?>ormawa/showDocumentByOrmawa/<?= $id ?>',
            async: false,
            dataType: 'json',
