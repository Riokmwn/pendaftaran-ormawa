...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="container-fluid">
            <!-- DataTales Example -->
            <a href="<?= base_url('ormawa/add_student_to_member') ?>" type="button" class="btn btn-primary mb-2" id="btnAdd">Terima Anggota</a>
...
<script>
    ...
    $('#show_data').on('click', '.item-delete', function() {
        ...
        if (confirmation) {
            $.ajax({
                type: 'get',
                async: false,
                url: '<?php echo base_url() ?>Ormawa/delete_candidate_to_member/',
                data: {
                    id: id
                },
                dataType: 'json',
    ...
    function showAllStudentRegistrationMemberOrmawa() {
        $.ajax({
            url: '<?php echo base_url() ?>Ormawa/accept_member_ormawa/<? $id_student_registration ?>',
            async: false,
            dataType: 'json',
