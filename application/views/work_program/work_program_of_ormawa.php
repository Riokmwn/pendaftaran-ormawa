...
<script>
    ...
    function showAllWorkProgram() {
        $.ajax({
            url: '<?php echo base_url() ?>Work_program/showWorkProgramByOrmawa/<?= $id_ormawa ?>',
            async: false,
            dataType: 'json',
            success: function(data) {
                // console.log(data);
                ...
                for (i = 0; i < data.length; i++) {
                    ...
                    html += '<tr>' +
                        ...
                        '<td class="text-center"><a href="<?= base_url('assets/document/proposal/') ?>' + data[i].document_work_program + '" type="button" class="btn btn-success">Download</a></td>' +
