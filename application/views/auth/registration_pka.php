                ...
                <div class="col-lg">
                    <div class="p-5">
                        <div class="text-center">
                            <h1 class="h4 text-gray-900 mb-4">Registrasi PKA</h1>
                        </div>
                        <form class="user" method="post" action="<?= base_url('auth/registration_pka'); ?>">
                            ...
                            <div class="form-group">
                                <select class="form-control form-control-sm" id="position" name="position">
                                    <?php foreach ($dataPositionPka as $data) { ?>
                                        <option value="<?= $data->id_pka_position ?>"><?= $data->name_pka_position ?></option>
                                    <?php } ?>
                                </select>
